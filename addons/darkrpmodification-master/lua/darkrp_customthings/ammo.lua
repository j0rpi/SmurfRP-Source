...
-- Pistol ammo type. Used by p228, desert eagle and all other pistols
DarkRP.createAmmoType("pistol", "Pistol", "models/Items/BoxSRounds.mdl", 30, 24)

-- Buckshot ammo, used by the shotguns
DarkRP.createAmmoType("buckshot", "Shotgun", "models/Items/BoxBuckshot.mdl", 50, 8)

-- Rifle ammo, usually used by assault rifles
DarkRP.createAmmoType("smg1", "Rifle", "models/Items/BoxMRounds.mdl", 80, 30)

-- Sniper ammo, usually used by sniper rifles
DarkRP.createAmmoType("StriderMinigun", "Sniper", "models/Items/item_item_crate.mdl", 120, 10)
