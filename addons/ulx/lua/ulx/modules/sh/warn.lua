...
CreateConVar("ulx_warnkick_num", 5, FCVAR_ARCHIVE, "Number of warnings a player needs before they are kicked/banned.")
CreateConVar("ulx_warnkick_decayrate", 300, FCVAR_ARCHIVE, "Minutes a player needs to be connected before their warning count is decreased by 1.")
CreateConVar("ulx_warnkick_ban", 1, FCVAR_ARCHIVE, "If this is set to 1, the script will issue a temp ban instead of a kick.")
CreateConVar("ulx_warnkick_bantime", 720, FCVAR_ARCHIVE, "How long in minutes a player is banned if ulx_warkick_ban is set to 1.")
