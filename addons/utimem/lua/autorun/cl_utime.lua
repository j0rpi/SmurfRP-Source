...
function buildCP( cpanel )
		...
		local lblOutsideColor = vgui.Create( "DLabel" )
		lblOutsideColor:SetText( "Outside Color" )
		lblOutsideColor:SetTextColor( Color(0, 0, 0, 255) )
		cpanel:AddItem( lblOutsideColor )
		
		local cmOutsideColor = vgui.Create( "DColorMixer" )
		cmOutsideColor:SetPalette( false )
		cmOutsideColor:SetAlphaBar( false )
		cmOutsideColor:SetTall( 150 )
		cmOutsideColor:SetConVarR( "utime_outsidecolor_r" )
		cmOutsideColor:SetConVarG( "utime_outsidecolor_g" )
		cmOutsideColor:SetConVarB( "utime_outsidecolor_b" )
		cpanel:AddItem( cmOutsideColor )
		
		local lblOutsideTextColor = vgui.Create( "DLabel" )
		lblOutsideTextColor:SetText( "Outside Text Color" )
		lblOutsideTextColor:SetTextColor( Color(0, 0, 0, 255) )
		cpanel:AddItem( lblOutsideTextColor )
		
		local cmOutsideText = vgui.Create( "DColorMixer" )
		cmOutsideText:SetPalette( false )
		cmOutsideText:SetAlphaBar( false )
		cmOutsideText:SetTall( 150 )
		cmOutsideText:SetConVarR( "utime_outsidetext_r" )
		cmOutsideText:SetConVarG( "utime_outsidetext_g" )
		cmOutsideText:SetConVarB( "utime_outsidetext_b" )
		cpanel:AddItem( cmOutsideText )
        
		local lblInsideColor = vgui.Create( "DLabel" )
		lblInsideColor:SetText( "Inside Color" )
		lblInsideColor:SetTextColor( Color(0, 0, 0, 255) )
		cpanel:AddItem( lblInsideColor )
		
		local cmInsideColor = vgui.Create( "DColorMixer" )
		cmInsideColor:SetPalette( false )
		cmInsideColor:SetAlphaBar( false )
		cmInsideColor:SetTall( 150 )
		cmInsideColor:SetConVarR( "utime_insidecolor_r" )
		cmInsideColor:SetConVarG( "utime_insidecolor_g" )
		cmInsideColor:SetConVarB( "utime_insidecolor_b" )
		cpanel:AddItem( cmInsideColor )
		
		local lblInsideText = vgui.Create( "DLabel" )
		lblInsideText:SetText( "Inside Text Color" )
		lblInsideText:SetTextColor( Color(0, 0, 0, 255) )
		cpanel:AddItem( lblInsideText )
		
		local cmInsideText = vgui.Create( "DColorMixer" )
		cmInsideText:SetPalette( false )
		cmInsideText:SetAlphaBar( false )
		cmInsideText:SetTall( 150 )
		cmInsideText:SetConVarR( "utime_insidetext_r" )
		cmInsideText:SetConVarG( "utime_insidetext_g" )
		cmInsideText:SetConVarB( "utime_insidetext_b" )
		cpanel:AddItem( cmInsideText )
...
function popToolMenu()
        spawnmenu.AddToolMenuOption( "Utilities", "UTime Controls", "UTime", "UTime", "", "", buildCP, { SwitchConVar = "utime_enable" } )
end
